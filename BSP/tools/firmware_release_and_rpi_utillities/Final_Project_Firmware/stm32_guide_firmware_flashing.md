...
| 버전 | 날짜 | 주요 변경사항 |
|------|------|--------------|
| v1 | 2026-02-22 | 모터 제어 시, PID 없이 PWM 값을 그대로 사용  |
| v2 | 2026-02-24 | 모터 PID 제어 코드 기본 구현 |
| v3 | 2026-03-01 | 모터 PID 제어 코드 수정 | 
| v4 | 2026-03-04 | 프로젝트 디렉터리 구조 및 파일 이름 기본 리팩토링 | 
| v5 | 2026-03-08 | 모터 PID 파라미터 튜닝 (Kp = 1, KI_L = 1, KI_R = 1.2, KD = 0) |
| v6 | 2026-03-09 | 모터 정지 시 소리나는 문제 해결, 정지 시 PID 리셋 코드 추가 |
